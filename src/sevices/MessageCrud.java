...
public class MessageCrud {
    ...
    public MessageCrud() {
     ...
     public List<Message> afficherMessage(){
      ...
      public List<Message> afficherMessage1(){
        ...
        try {
           ...
           //     n.setId_message(rs.getInt("id_message"));
                n.setContenu(rs.getString("contenu"));
          //  n.setDate_message(rs.getString("date_message"));
     ...
     public List<Message> updateMessage(Message e ){
        List<Message> message = new ArrayList<>();
        String sql="UPDATE message SET id_message = ?, contenu = ? WHERE id_message ="+e.getId_message();
         try {
            ste=mc.prepareStatement(sql);
            ste.setInt(1, e.getId_message());
            ste.setString(2, e.getContenu());
//            ste.setString(3, e.getDate_message());
            ste.executeUpdate();
