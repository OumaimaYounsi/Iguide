...
public class FeedbackCrud {
    ...
    public FeedbackCrud (){
     ...
     String sql = "insert into feedback(contenu,date_feedback,id_c,id_a,id_ac,id_s,id_p) Values(?,?,?,?,?,?,?)";
        try {
     ...
     public List<Feedback> updateFeedback(int id_feedback,String contenu ){

List<Feedback> Feedback = new ArrayList<>();
        try {
  
            String req = "UPDATE feedback SET contenu ='" + contenu
