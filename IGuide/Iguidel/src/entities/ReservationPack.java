...
public class ReservationPack {
 private int id_res_pack;
   ...
   private int id_pack;
    ...
    public ReservationPack(int id_res_pack, Date date_pack, int id_client, int id_accomp, int id_pack) {
    ...
    public ReservationPack(Date date_pack) {
        this.date_pack = date_pack;
    }
    
    

    public ReservationPack(Date date_pack, int id_client, int id_accomp, int id_pack) {
        this.date_pack = date_pack;
        this.id_client = id_client;
        this.id_accomp = id_accomp;
        this.id_pack = id_pack;
